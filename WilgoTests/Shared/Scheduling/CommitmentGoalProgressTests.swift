...
final class CommitmentGoalProgressTests {
    ...
    @MainActor func exactlyMet_isMetTrue() throws {
        ...
        let now = testDate(year: 2026, month: 3, day: 5, hour: 18)
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 5, hour: 8), in: ctx)
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 5, hour: 10), in: ctx)
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 5, hour: 14), in: ctx)
    ...
    @MainActor func checkInsOutsideDailyCycle_notCounted() throws {
        ...
        let ctx = container.mainContext
        let c = makeCommitment(targetCount: 3, in: ctx)
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 4, hour: 10), in: ctx) // day before
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 6, hour: 10), in: ctx) // day after
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 5, hour: 10), in: ctx) // in-cycle
    ...
    @MainActor func differentNow_recomputesForCorrectCycle() throws {
        ...
        let c = makeCommitment(targetCount: 3, in: ctx)
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 5, hour: 10), in: ctx)
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 7, hour: 10), in: ctx)
        addCheckIn(to: c, at: testDate(year: 2026, month: 3, day: 7, hour: 14), in: ctx)

        let progressA = c.goalProgress(now: testDate(year: 2026, month: 3, day: 5, hour: 20))
        let progressB = c.goalProgress(now: testDate(year: 2026, month: 3, day: 7, hour: 20))
    ...
    @MainActor func weeklyCycle_checkInsInWeekCounted_outsideNot() throws {
        ...
        addCheckIn(to: c, at: testDate(year: 2026, month: 1, day: 1, hour: 10), in: ctx)  // Thu week 1
        addCheckIn(to: c, at: testDate(year: 2026, month: 1, day: 3, hour: 10), in: ctx)  // Sat week 1
        addCheckIn(to: c, at: testDate(year: 2026, month: 1, day: 5, hour: 10), in: ctx)  // Mon week 1
        addCheckIn(to: c, at: testDate(year: 2026, month: 1, day: 8, hour: 10), in: ctx)  // Thu week 2
        addCheckIn(to: c, at: testDate(year: 2026, month: 1, day: 9, hour: 10), in: ctx)  // Fri week 2

        let week1 = c.goalProgress(now: testDate(year: 2026, month: 1, day: 5, hour: 12))
        #expect(week1.leftToDo == 0)
        #expect(week1.isMet == true)

        let week2 = c.goalProgress(now: testDate(year: 2026, month: 1, day: 10, hour: 12))
