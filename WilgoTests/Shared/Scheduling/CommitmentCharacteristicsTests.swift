...
final class CommitmentCharacteristicsTests {
    ...
    @MainActor func openSlotIsCurrent() throws {
        ...
        #expect(snap.currentOccurrence?.start == testDate(year: 2026, month: 3, day: 5, hour: 9))
    }
    ...
    @MainActor func laterSlotNotCurrentHasUpcoming() throws {
        ...
        #expect(snap.nearestUsable?.start == testDate(year: 2026, month: 3, day: 5, hour: 9))
    }
    ...
    @MainActor func nearestInNextCycle() throws {
        ...
        #expect(snap.nearestUsable?.start == testDate(year: 2026, month: 3, day: 6, hour: 7))
        #expect(!snap.nearestUsableInCurrentCycle)
    }
