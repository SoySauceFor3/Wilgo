...
final class SlotIsSnoozedTests {
    ...
    @MainActor func isSnoozed_crossMidnight_postMidnightMatchesPreviousDay() throws {
        ...
        let snooze = SlotSnooze(
            slot: slot, psychDay: dec31, snoozedAt: date(year: 2026, month: 1, day: 1, hour: 0))
        ctx.insert(snooze)
    ...
    @MainActor func isSnoozed_crossMidnight_preMidnightMatchesCurrentDay() throws {
        ...
        let dec31 = date(year: 2025, month: 12, day: 31)
        let snooze = SlotSnooze(
            slot: slot, psychDay: dec31, snoozedAt: date(year: 2025, month: 12, day: 31, hour: 23))
        ctx.insert(snooze)
    ...
    @MainActor func isSnoozed_crossMidnight_jan1SnoozeDoesNotMatchDec31Occurrence() throws {
        ...
        let snooze = SlotSnooze(
            slot: slot, psychDay: jan1, snoozedAt: date(year: 2026, month: 1, day: 1, hour: 0))
        ctx.insert(snooze)
    ...
    @MainActor func isSnoozed_wrongTime_returnsFalse() throws {
        ...
        let snooze = SlotSnooze(
            slot: slot, psychDay: today, snoozedAt: date(year: 2026, month: 3, day: 5, hour: 10))
        ctx.insert(snooze)
    ...
    @MainActor func isSnoozed_wrongDay_returnsFalse() throws {
        ...
        let snooze = SlotSnooze(
            slot: slot, psychDay: monday, snoozedAt: date(year: 2026, month: 3, day: 2, hour: 10))
        ctx.insert(snooze)
